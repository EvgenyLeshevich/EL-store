    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbarsExample07" style="">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown07" data-bs-toggle="dropdown"
                       aria-expanded="false">Сменить язык</a>
            ...
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" method="get" action="/catalog/mobile/0">
                <input type="search" class="form-control form-control-dark" placeholder="Поиск..." name="name" aria-label="Search">
            </form>
                ...
                <sec:authorize access="isAuthenticated()">
                    <div class="dropdown text-end">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-macos mx-0 border-0 shadow"
                            ...
                            <li><a class="dropdown-item" href="/profile/security">Безопасность аккаунта</a></li>
                            <li><a class="dropdown-item" href="#">Корзина</a></li>
                            <li><a class="dropdown-item" href="#">Мои заказы</a></li>
                            <li><a class="dropdown-item" href="#">Обсуждения</a></li>
                            <li>
